...
4. Launch Ultrahand (similarly to `Tesla Menu`) with Ultrahand's (`ZL+ZR+DDOWN`) or Tesla's default hotkeys.  A new folder will be made (`/switch/.packages/`) with a preset `package.ini` file for your base menu commands.
