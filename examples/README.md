...
- [OC Toolkit](OC%20Toolkit/README.md): OC Toolkit example demonstrates how to push your device's performance to the limit by applying custom overclocks, timings, and undervoltage settings to overclocking-kip files.
