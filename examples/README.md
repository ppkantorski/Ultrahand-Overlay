...
- [OC Optimizer](OC%20Optimizer/README.md): OC Optimizer example demonstrates how to push your device's performance to the limit by applying custom overclocks, timings, and undervoltage settings to overclocking kip files.
