...
const std::string WALLPAPER_PATH = "sdmc:/config/ultrahand/wallpaper.rgba";
...
const std::string LATEST_RELEASE_INFO_URL = "https://raw.githubusercontent.com/ppkantorski/Ultrahand-Overlay/dev/RELEASE.ini";
